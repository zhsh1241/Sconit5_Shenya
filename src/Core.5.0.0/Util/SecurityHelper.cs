namespace com.Sconit.Utility
{
    ...
    public static class SecurityHelper
    {
        ...
        {
            return HasPermission(orderMaster.Type, orderMaster.IsCheckPartyFromAuthority, orderMaster.IsCheckPartyToAuthority, orderMaster.PartyFrom, orderMaster.PartyTo, isSupplier, orderMaster.SubType == com.Sconit.CodeMaster.OrderSubType.Return ? true : false);
        }
        ...
        {
            return HasPermission(pickListMaster.OrderType, pickListMaster.IsCheckPartyFromAuthority, pickListMaster.IsCheckPartyToAuthority, pickListMaster.PartyFrom, pickListMaster.PartyTo, isSupplier, false, false);
        }
        ...
        public static bool HasPermission(OrderType orderType, bool isCheckPartyFromAuthority, bool isCheckPartyToAuthority, string partyFrom, string partyTo, bool isSupplier, bool isReturnOrder, bool isCreateOrder = true)
        {
            try
            {
