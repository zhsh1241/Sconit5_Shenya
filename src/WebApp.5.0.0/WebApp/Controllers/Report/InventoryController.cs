...
namespace com.Sconit.Web.Controllers.Report
{
    public class InventoryController : WebAppBaseController
    {
        ...
        public ActionResult ExportInventoryMonitor(string location, string itemCategory, string materialsGroup, string item, string inventoryType)
        {
            var table = _GetInventoryMonitor(location, itemCategory, materialsGroup, item, inventoryType);
        ...
        [SconitAuthorize(Permissions = "Url_Inventory_InventoryMonitor")]
        public string _GetInventoryMonitor(string location, string itemCategory, string materialsGroup, string item, string inventoryType)
        {
            ...
            sqlParams[4] = new SqlParameter("@InventoryType", inventoryType);
