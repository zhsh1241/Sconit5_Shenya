namespace com.Sconit.Web.Controllers.Report
{
    ...
    public class CustReportController : WebAppBaseController
    {
        ...
        [SconitAuthorize(Permissions = "Url_CustReport_DOHReport")]
        public ActionResult DOHReport()
        {
            return View();
        }
        ...
        [SconitAuthorize(Permissions = "Url_CustReport_DOHReport")]
        public ActionResult ExportDOHReport(string startDate)
        {
            var table = _GetDOHReport(startDate);
            return new DownloadFileActionResult(table, "DOH.xls");
        }

        [SconitAuthorize(Permissions = "Url_CustReport_DOHReport")]
        public string _GetDOHReport(string startDate)
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@StartDate", startDate);
            DataSet ds = genericMgr.GetDatasetByStoredProcedure("USP_Report_DOH", sqlParams);
            ...
            str.Append("<th>");
            str.Append("未来第1-4周需求");
            str.Append("</th>");

            str.Append("<th>");
            str.Append("未来第5-8周需求");
            str.Append("</th>");
