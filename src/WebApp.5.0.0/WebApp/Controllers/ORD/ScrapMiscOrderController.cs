...
{
    public class ScrapMiscOrderController : WebAppBaseController
    {
        ...
        #region view
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_View")]
        public ActionResult Index()
        {
            //ViewBag.SearchType = "CostCenter";
            return View();
        }
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrderDet_View")]
        ...
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_ScrapView")]
        ...
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrderDet_ScrapView")]
        ...
        [GridAction(EnableCustomBinding = true)]
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_View,Url_ScrapMiscOrder_ScrapView")]
        ...
        #region new
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_New")]
        ...
        [AcceptVerbs(HttpVerbs.Post)]
        [GridAction]
        [SconitAuthorize(Permissions = "Url_ExProductionOrder_ScrapNew")]
        public ActionResult CreateScrapMiscOrder(MiscOrderMaster miscOrderMaster, string sequences, string items, string locations, string qtys)
        {
            try
            {
                ...
                for (int i = 0; i < ItemsArray.Length; i++)
                {
                    ...
                    if (item.ItemCategory != "ZHJC")
                    {
                        SaveErrorMessage(Resources.EXT.ControllerLan.Con_ExistNonHalfFinishGoodsType);
                        return Json(null);
                    }
                }
                CreateNewMiscOrder(miscOrderMaster, sequences, items, locations, qtys, true);
        ...
        private void CreateNewMiscOrder(MiscOrderMaster miscOrderMaster, string sequences, string items, string locations, string qtys, bool isScrap = false)
        {
        ...
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_New,Url_ExProductionOrder_ScrapNew")]
        public ActionResult _MiscOrderDetail(string miscOrderNo, string location, string referenceNo, int? referenceDocumentsType)
        {
            ViewBag.ReferenceDocumentsType = 0;
        ...
        [GridAction(EnableCustomBinding = true)]
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_New,Url_ExProductionOrder_ScrapNew")]
        public ActionResult _SelectMiscOrderDetail(string miscOrderNo, string location, string referenceNo)
        {
        ...
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_Edit")]
        ...
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_ScrapEdit")]
        ...
        public ActionResult EditMiscOrder(MiscOrderMaster miscOrderMaster, string sequences, string items, string qtys)
        {
            try
            {
                var oldMiscOrderMaster = EditnewMiscOrder(miscOrderMaster, sequences, items, qtys);
        ...
        [HttpPost]
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_ScrapEdit")]
        public ActionResult ScrapEditMiscOrder(MiscOrderMaster miscOrderMaster, string sequences, string items, string qtys)
        {
            try
            {
                string[] ItemsArray = items.Split(',');
        ...
        private MiscOrderMaster EditnewMiscOrder(MiscOrderMaster miscOrderMaster, string sequences, string items, string qtys)
        {
            ...
            oldMiscOrderMaster.CostCenter = oldMiscOrderMaster.SubType == CodeMaster.MiscOrderSubType.MES26 ? "212" : miscOrderMaster.CostCenter;
        ...
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_Confirm")]
        ...
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_ScrapConfirm")]
        ...
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrderDet_ScrapView,Url_ScrapMiscOrderDet_View")]
        [GridAction(EnableCustomBinding = true)]
        ...
        private string PrepareSqlSearchStatement(MiscOrderSearchModel searchModel)
        {
            ...
            whereStatement += string.Format(" and m.SubType ={0}", searchModel.SearchType == "CostCenter" ? (int)CodeMaster.MiscOrderSubType.COST : (int)CodeMaster.MiscOrderSubType.MES26);
            if (searchModel.StartDate != null && searchModel.EndDate != null)
            {
        ...
        [SconitAuthorize(Permissions = "Url_ScrapMiscOrder_ScrapView,Url_ScrapMiscOrder_View")]
        [GridAction(EnableCustomBinding = true)]
