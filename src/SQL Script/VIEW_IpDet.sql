...
SELECT     Id, IpNo, OrderDetId, Item, ItemDesc, RefItemCode, Uom, UC, QualityType, Qty, RecQty, UnitQty, LocFrom, LocFromNm, LocTo, LocToNm, IsInspect, BillAddr, PriceList, 
                      ...
                      Version, Seq, OrderNo, OrderDetSeq, OrderType, OrderSubType, ManufactureParty, BaseUom, Type, GapRecNo, GapIpDetId, UCDesc, Container, ContainerDesc, ExtNo, ExtSeq, StartTime, WindowTime, BinTo,
                      IsScanHu, IsChangeUC, Flow
